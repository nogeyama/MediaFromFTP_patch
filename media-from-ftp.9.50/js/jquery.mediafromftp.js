...
jQuery(function(){
	...
	jQuery('#mediafromftp_ajax_update').submit(function(){
		...
		jQuery("#mediafromftp-loading-container").append("<div id=\"mediafromftp-update-progress\"><progress value=\"0\" max=\"100\"></progress> 0%</div>");
	...
	jQuery('#medialibraryimport_ajax_update').submit(function(){
		...
		jQuery("#medialibraryimport-loading-container").append("<div id=\"medialibraryimport-update-progress\"><progress value=\"0\" max=\"100\"></progress> 0%</div>");
