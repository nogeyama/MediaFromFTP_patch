...
class TT_MediaFromFtp_List_Table extends WP_List_Table {
	...
	function get_bulk_actions() {
		...
		<div class="submit" style="padding-top: 5px; padding-bottom: 5px;">
			<input type="hidden" name="searchdir" value="<?php echo $searchdir; ?>" form="mediafromftp_ajax_update">
			<input type="hidden" name="ext2type" value="<?php echo $ext2typefilter; ?>" form="mediafromftp_ajax_update">
			<input type="hidden" name="extension" value="<?php echo $extfilter; ?>" form="mediafromftp_ajax_update">
			<input type="submit" class="button-primary button-large" value="<?php _e('Update Media'); ?>" form="mediafromftp_ajax_update" />
		</div>
		<?php
